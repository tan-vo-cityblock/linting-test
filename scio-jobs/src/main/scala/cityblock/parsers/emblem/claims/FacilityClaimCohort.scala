...
object FacilityClaimCohort {
  @BigQueryType.toTable
  case class ParsedFacilityClaimCohort(
    CLAIM_ID: String,
    ...
    SERVICEYEARMONTH: Option[LocalDate],
    IPOPINDICATOR: Option[String],
    DRGCODE: Option[String],
    DRGVERSION: Option[String],
    SERVICEACTIVITYDATE: Option[LocalDate],
    CHECKACCOUNTNUMBER: Option[String],
    CHECKDATE: Option[LocalDate],
