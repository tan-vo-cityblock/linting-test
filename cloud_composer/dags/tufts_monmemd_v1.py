...
load_to_bigquery = GoogleCloudStorageToBigQueryOperator(
    ...
    source_objects=[
        "tufts_production/drop/CBH.P.FH7419.MONMEMD.D" + year_month[2:] + "*"
    ],
...
extract_human_readable = bigquery_operator.BigQueryOperator(
    ...
    destination_dataset_table=f"tufts-data.cms_revenue.mmr_monmemd_7419_{year_month}01",
    priority="BATCH",
