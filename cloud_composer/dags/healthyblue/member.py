...
steps, dag = cbh_DAG("healthyblue_member_v1")
...
to_silver = steps.LoadToSilver(
    ...
    input_config_paths=["healthyblue_silver/member.txt"],
...
attribution = steps.Attribution(
    task_id="att",
    deployTo="healthyblueproduction",
    bigQueryProject=PAYER_GCP_PROJECT,
    bigQueryDataset="silver_claims",
)

(pull_conf >> to_silver >> silver_views >> attribution)
