...
dag = DAG(
    dag_id="publish_cci_amisys_gold_data_v1",
...
dbt_run_cmd = """	
    dbt deps &&	
    dbt run --model source:cci+ source:cci_silver+ --exclude tag:nightly+ abstractions.computed
"""
...
email_stakeholders = EmailOperator(
    ...
    subject="Airflow: CCI Amisys data published for shard: {{ task_instance.xcom_pull(task_ids='get_latest_drop_date') }}",
