...
environment = "prod"
gcs_export_bucket = "cbh-cloud-sql-export-member-index-prod"
instance_connection_name = "cityblock-data:us-east1:member-index"
instance_project = "cityblock-data"
instance_name = "member-index"
database_name = "prod"
bq_project = "cbh-db-mirror-prod"
bq_output_dataset = "member_index_mirror"
svc_acct = "prod-member-index-mirror@cbh-db-mirror-prod.iam.gserviceaccount.com"
...
gcp_secrets = secret.Secret(
    ...
    secret="tf-svc-prod-member-index-mirror",
    key="key.json",
)
...
user_env = secret.Secret(
    deploy_type="env",
    deploy_target="USER",
    secret="cbh-db-mirror-member-index-prod-secrets",
...
dag = DAG(
    dag_id="prod_member_index_mirroring_v1",
    start_date=datetime.datetime(2021, 1, 19, 20),  # 8AM UTC => 3AM EST / 4AM EDT
