# COPIED FROM https://github.com/apache/airflow/blob/master/airflow/providers/pagerduty/hooks/pagerduty.py
# AS THIS IS NOT AVAILABLE IN CURRENT CLOUD COMPOSER VERSION (AIRFLOW 1.10.6)
#
...
class PagerdutyHook(BaseHook):
    ...
    def __init__(self, token: Optional[str] = None, pagerduty_conn_id: Optional[str] = None) -> None:
        super().__init__(pagerduty_conn_id)  # only difference from source; part of legacy `BaseHook`s
