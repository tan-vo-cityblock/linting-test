...
WHERE
  ...
  -- needs to be a 1 quarter lag
  and f.header.date.from between DATE_TRUNC(DATE_SUB(current_date, INTERVAL 1 Quarter), QUARTER) and last_day(date_sub(current_date, interval 1 QUARTER), QUARTER)
