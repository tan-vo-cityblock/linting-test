...
with memmast as (
  select * from {{ ref('master_member_base_tufts') }}
),
...
Islands as (
  SELECT distinct
    ...
    --  DATES
      ...
      'tufts' as source, -- temporary. prob  need to replace this with 'historic' vs 'daily'
      spanFromDate,
      spanToDate,
      eligStartDate,
      eligEndDate,
   ...
   group by
    ...
    --  DATES
      ...
      eligStartDate,
      eligEndDate,
      source, -- temporary. prob  need to replace this with 'historic' vs 'daily'
    --  DEMOGRAPHICS
      lastName,
      firstName,
      dateOfBirth,
