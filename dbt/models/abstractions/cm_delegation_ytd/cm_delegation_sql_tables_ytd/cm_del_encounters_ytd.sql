...
claims_completion as (
 select
    *,
    ...
    DATE_SUB(DATE_TRUNC(DATE_SUB({{var("cm_reporting_claims_date_ytd")}}, INTERVAL 3 MONTH), MONTH), INTERVAL 1 DAY) as claims_completion_month
 from {{ ref('cm_del_patients_ytd') }} patients
),
